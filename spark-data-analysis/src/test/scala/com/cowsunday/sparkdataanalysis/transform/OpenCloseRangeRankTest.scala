...
class OpenCloseRangeRankTest extends Specification {

  private val master = "local[2]"
  private val appName = "OpenCloseRangeRankTest-test"
  ...
  @Test def testTransform() {
    ...
    val results = OpenCloseRangeRank.transform(rdd, 3).take(5)
