...
class LargestUpBarInSeriesTest extends Specification {

  private val master = "local[2]"
  private val appName = "LargestUpBarInSeries-test"
  ...
  @Test def testTransform() {
    val priceBars = Seq(new PriceBar(4,2,0.5,5,20150101),
        new PriceBar(4,4,1.5,5.5,20150102),
        new PriceBar(10,6,2.5,100,20150103),
    ...
    val results = LargestUpBarInSeries.transform(rdd, 3).take(5)
