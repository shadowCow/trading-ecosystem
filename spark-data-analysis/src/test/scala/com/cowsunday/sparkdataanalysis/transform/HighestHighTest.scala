...
class HighestHighTest extends Specification {

  private val master = "local[2]"
  private val appName = "HighestHigh-test"
  ...
  @Test def testTransform() {
    val priceBars = Seq(new PriceBar(4,2,0.5,3,20150101),
        ...
        new PriceBar(6,5,4.5,5.5,20150105),
        new PriceBar(20,3,5.5,13,20150106),
        new PriceBar(13,10,6.5,9,20150107))
    val rdd = sc.parallelize(priceBars)

    val results = HighestHigh.transform(rdd, 3).take(5)
