...
class LargestPriceChangeSeriesTest extends Specification {

  private val master = "local[2]"
  private val appName = "LargestPriceChangeSeries-test"
  ...
  @Test def testTransform() {
    val priceBars = Seq(new PriceBar(4,2,0.5,3,20150101),
        ...
        new PriceBar(20,9,5.5,27,20150106),
        new PriceBar(13,10,6.5,35,20150107))
    val rdd = sc.parallelize(priceBars)

    val results = LargestPriceChangeSeries.transform(rdd, 4, 2).take(3)
