...
class SmallestDownBarInSeriesTest extends Specification {

  private val master = "local[2]"
  private val appName = "SmallestDownBarInSeries-test"
  ...
  @Test def testTransform() {
    val priceBars = Seq(new PriceBar(5,2,0.5,3,20150101),
        new PriceBar(4,4,1.5,2.5,20150102),
        new PriceBar(4.5,6,2.5,4,20150103),
    ...
    val results = SmallestDownBarInSeries.transform(rdd, 3).take(5)
