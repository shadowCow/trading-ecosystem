...
class LargestPriceChangeTest extends Specification {

  private val master = "local[2]"
  private val appName = "LargestPriceChangeTest-test"
  ...
  @Test def testTransform() {
    ...
    val results = LargestPriceChange.transform(rdd, 3).take(5)
