...
class SmallestUpBarInSeriesTest extends Specification {

  private val master = "local[2]"
  private val appName = "SmallestUpBarInSeries-test"
  ...
  @Test def testTransform() {
    val priceBars = Seq(new PriceBar(1,2,0.5,3,20150101),
        new PriceBar(1,4,1.5,2.5,20150102),
    ...
    val results = SmallestUpBarInSeries.transform(rdd, 3).take(5)
